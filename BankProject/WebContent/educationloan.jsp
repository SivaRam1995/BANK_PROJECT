...
<body>
	...
	<form class="heading1">
		...
		<ul>
			...
			<li>Loan Amount - Minimum- Rs. 50,000 and Maximum- Rs. 6,00,000</li>
			...
			<li>Income - Not mandatory<br> <br> <br></li>
	...
	<form class="heading1 hd">
		<div class="split">
			<h4>About Education Loans</h4>
			<br>
			<p>ABC BANK offers Education Loan to help students pay their
				tuition fees and living cost when they are looking to take the next
				steps in their education, both in India and abroad. With quick
				approval rates, minimal documentation and competitive interest
				rates, we are levelling the playing field so that students can
				fulfil their potential. The highest quality of education should be
				available for all regardless of someones financial background. That
				is precisely the reason why we have made the availability of Student
				Loans as accessible as possible. Whether you are a student or a
				parent seeking to provide your children with the very best, we are
				here to support you.</p>
		</div>
		<br>
		<div class="split">
			<h4>Benifits of Education Loan</h4>
			<br>
			<ul>
				<li><b>A better career :</b> Statistics show that students who
					graduate from educational institutes that have a good reputation
					tend to secure better jobs post their studies. This eventually sets
					them on a path to a fruitful career.</li>
	...
	<form id="EMI">
		...
		<div class="mb-3">
			<label for="exampleInputEmail1" class="form-label">INTREST
				...
				onchange=emi(); disabled value="8.5" required="required">
		</div>
	...
	<form action="EducationLoan" id="bike">
		<h1>EDUCATION LOAN FORM</h1>
		<div class="mb-3">
		...
		<div class="mb-3">
			<label class="form-label">TYPE OF LOAN</label> <select
				...
				<option value="Higher Education" selected>HIGHER EDUCATION</option>
			</select>
		</div>
		<div class="mb-3">
