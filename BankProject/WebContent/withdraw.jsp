...
<body>
	...
	<form action="WithdrawMoney" method="post">
		...
		<div id="right">
			<button type="submit" class="btn btn-primary" id="searching">WITHDRAW</button>
			<input type="number" id="tags" placeholder="Enter Account Number "
	...
	<script>
		function myFunction() {
			if (document.getElementById("amo").value == "") {
				document.getElementById("amo").style.borderColor = "red";
			} else {
