	...
	<form action="SaveCustomer">
		<table class="table table-bordered table-dark table-striped">
			...
			<tr>
				...
				<td><input type="number" class="form form-control" name="pin"
					value="<%=pin%>" pattern="/^-?\d+\.?\d*$/"
			...
			<tr>
				<td><b>Login Id</b></td>
				<td><input type="text" class="form form-control" name="log"
					value="<%=login%>" required="required"></td>
			</tr>
			<tr>
				<td><b>Password</b></td>
				<td><input type="text" class="form form-control" name="pass"
					value="<%=password%>"
					pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{10,}" required="required"
					title="Must contain at least one number and one uppercase and lowercase letter, and at least 10 or more characters"></td>
			</tr>
			<tr>
				<td><b>Email Id</b></td>
			...
			<tr>
				<td><a href="myprofile.jsp" class="btn btn-primary">CANCEL</a></td>
