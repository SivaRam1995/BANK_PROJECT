...
<body>
	...
	<form class="heading1">
		...
		<ul>
			...
			<li>Loan Amount - Minimum- Rs. 50,000 and Maximum- Rs. 40,00,000</li>

			<li>Tenor - Minimum- 24 months and Maximum- 120 months</li>
	...
	<form class="heading1 hd">
		<div class="split">
			...
			<br>
			<p>A home loan, also known as a housing loan is simply the sum of
				money borrowed from a lender to purchase a home or to construct one.
				Home loans can also be taken for extension of existing homes. Home
				loans are available in both fixed and adjustable interest rates, and
				payment terms. There are several types of home loans available:</p>
			<ul>
		...
		<br>
		<div class="split">
			<h4>How to Apply for a Home Loan?</h4>
			<br>
			<ul>
				<li><b>Online :-</b><br> You can easily apply for a
					housing loan online by just filling up your basic details.</li>
			</ul>
		</div>
	</form>
	...
	<form id="EMI">
		...
		<div class="mb-3">
			<label for="exampleInputEmail1" class="form-label">INTREST
				...
				onchange=emi(); disabled value="10.9" required="required">
		</div>
	...
	<form action="HomeLoan" id="bike">
		<h1>HOME LOAN FORM</h1>
		<div class="mb-3">
		...
		<div class="mb-3">
			<label class="form-label">Tenor</label> <select
				...
				<option value="24">SELECT MONTHS(By Default Select 24)</option>
