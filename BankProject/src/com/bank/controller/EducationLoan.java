...
@WebServlet("/EducationLoan")
public class EducationLoan extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		float intrest = (float) 8.5;
		BankLoan bankLoan = new BankLoan();
		boolean eligibility = bankLoan.eligibility(required_amt, your_mothly_salary, tenor, intrest);
		if (eligibility) {
			out.println("<script>");
			out.println(
					"alert('THANK YOU FOR APPLYLING EDUCATION LOAN YOU ARE ELIGIBLE TO TAKE THE LOAN OUR EXECUTIVE WILL REACH YOU');");
			...
			out.println("<script>");
			out.println("alert('SORRY....AT THE MOMENT YOU ARE NOT ELIGIBLE TO TAKE THE EDUCATION LOAN.');");
			out.println("location.href='loan.jsp';");
			out.println("</script>");
